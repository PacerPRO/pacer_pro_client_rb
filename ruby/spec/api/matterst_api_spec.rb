...
# Unit tests for PacerProClient::MatterstApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MatterstApi' do
  before do
    # run before each test
    @instance = PacerProClient::MatterstApi.new
  end
  ...
  describe 'test an instance of MatterstApi' do
    it 'should create an instact of MatterstApi' do
      expect(@instance).to be_instance_of(PacerProClient::MatterstApi)
    end
  end
