...
# Unit tests for SwaggerClient::Matter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Matter' do
  before do
    # run before each test
    @instance = SwaggerClient::Matter.new
  end
  ...
  describe 'test an instance of Matter' do
    it 'should create an instact of Matter' do
      expect(@instance).to be_instance_of(SwaggerClient::Matter)
    end
  end
  ...
  describe 'test attribute "last_filed_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "related_bankruptcy_case_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
