...
module PacerProClient
  ...
  class Matter
    ...
    def hash
      [id, case_id, client_matter_number, judge, case_number, case_title, nature_of_suit, docket_entries, activity_at, referral, filed_date, last_filed_date, closed_date, chapter, related_bankruptcy_case_number, parties].hash
    end
