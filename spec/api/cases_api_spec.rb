...
describe 'CasesApi' do
  ...
  before do
    ...
    @instance = PacerProClient::CasesApi.new(api_client)
  end
  ...
  describe 'cases_get_collection test' do
    it "should work" do
      ...
      expect(@instance.cases_get_collection).to all(be_a(PacerProClient::ModelCase))
    end
  end
  ...
  describe 'cases_get_parties test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      kase = cases.first
      expect(@instance.cases_get_parties(kase.id)).to all(be_a(PacerProClient::Party))
    end

    it "should raise an error if case id not found" do
      expect { @instance.cases_get_parties('abc') }.to raise_error(PacerProClient::ApiError, 'Not Found')
    end
  end
